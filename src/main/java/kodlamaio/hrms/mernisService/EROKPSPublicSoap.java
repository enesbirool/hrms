...
public class EROKPSPublicSoap
{
    ...
    public EROKPSPublicSoap(){}

    public EROKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public EROKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        EROExtendedSoapSerializationEnvelope envelope= new EROExtendedSoapSerializationEnvelope(EROExtendedSoapSerializationEnvelope.VER11);
